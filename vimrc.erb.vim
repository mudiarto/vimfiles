...
" Use ctags and current buffer for completion
set complete=.,t
...
" Spell checking and wrapping for text files
...
au BufWinLeave * silent! mkview "save folds
au BufWinEnter * silent! loadview "load saved folds
